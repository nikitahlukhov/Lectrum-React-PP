...
/******/ 	__webpack_require__.p = "/Lectrum-React-PP/";
/******/
/******/
...
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(136);
/* harmony import */ var react_hot_loader__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_hot_loader__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var components_Scheduler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(137);
var _dec, _class;
...
var v1 = __webpack_require__(150);
...
var styles_m = __webpack_require__(134);
...
class Spinner_Spinner extends react["Component"] {
  render() {
    ...
    return isSpinning ? react_default.a.createElement("div", {
      className: styles_m_default.a.spinner
    }) : null;
  }

}
// EXTERNAL MODULE: ./source/components/Task/styles.m.css
var Task_styles_m = __webpack_require__(2);
...
class Task_Task extends react["PureComponent"] {
  ...
  render() {
    ...
    return react_default.a.createElement("li", {
      className: Task_styles_m_default.a.task
...
const callApi = async ({
  ...
  try {
    const response = await fetch(MAIN_URL + (urlAddition.length > 0 ? `/${urlAddition}` : ""), _objectSpread({
      method,
...
const api = {
  ...
  completeAllTasks: async tasks => {
    const requests = tasks.map(task => api.updateTask(_objectSpread({}, task, {
      completed: true
    })));
...
class Scheduler_Scheduler extends react["Component"] {
  constructor(...args) {
    ...
    this._createTaskAsync = async event => {
      ...
      if (newTaskMessage.length > 0) {
        ...
        this.setState(stateCurrent => ({
          tasks: [...stateCurrent.tasks, Scheduler_objectSpread({}, response)],
          newTaskMessage: ""
        }));
    ...
    this._getFilteredTasks = (tasks, tasksFilter) => {
    ...
    this._completeAllTasksAsync = async () => {
      ...
      this.setState(currentState => ({
        tasks: currentState.tasks.map(task => Scheduler_objectSpread({}, task, {
          completed: true
        }))
      }));
  ...
  render() {
    ...
    return react_default.a.createElement("section", {
      ...
      duration: 400
    }, sortTasksByGroup(this._getFilteredTasks(tasks, tasksFilter)).map(({
      id,
      completed,
      favorite,
      message
    }) => react_default.a.createElement(Task_Task, {
...
/* harmony import */ var _theme_init__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(144);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(143)))
...
/***/ })
/******/ ]);
//# sourceMappingURL=source.82563.js.map